...
public class Android_layoutActivity extends Activity {
	...
	private boolean callAllService() {
		SharedPreferences prefs = getSharedPreferences(ProfileMeta.USER_INFO,
				MODE_PRIVATE);
		String id = prefs.getString(ProfileMeta.USER_ID, null);
		String password = prefs.getString(ProfileMeta.PASSWORD, null);
		SyncAllData allService = new SyncAllData(getBaseContext(), "tester", "scryed");
		return allService.Execute(ServiceMeta.PROFILE_SERVICE,
				ServiceMeta.FRIEND_SERVICE);
	}
	 ...
	 * MenuChoice(item); }
	 * 
	 * private void CreateMenu(Menu menu) { menu.setQwertyMode(true); MenuItem
	 * mnu1 = menu.add(0, 0, 0, "Login"); { mnu1.setAlphabeticShortcut('a');
	 * mnu1.setIcon(R.drawable.icon); } MenuItem mnu2 = menu.add(0, 1, 1,
	 * "Sign Up"); { mnu2.setAlphabeticShortcut('b');
	 * mnu2.setIcon(R.drawable.icon); } MenuItem mnu3 = menu.add(0, 2, 2,
	 * "visit our website"); { mnu3.setAlphabeticShortcut('c');
	 ...
	 * Toast.LENGTH_LONG).show(); return true; case 1: Toast.makeText(this,
	 * "You clicked on Item 2", Toast.LENGTH_LONG).show(); return true; case 2:
	 * Toast.makeText(this, "You clicked on Item 3", Toast.LENGTH_LONG).show();
	 * return true; case 3: Toast.makeText(this, "You clicked on Item 4",
